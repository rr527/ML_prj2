...
%create a netual net
clear nn;
nn = nn_create([6,10,10,10,10,10,10,2],'active function','relu','learning rate',0.01, 'batch normalization',0,'optimization method','RMSPropwNM', 'objective function', 'MSE');
